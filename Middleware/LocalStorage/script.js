...
const initialState = {
    loading: false,
    dados: getLocalStorage("dados", null),
    erro: null
};
...
const enchancer = composeEnhancers(applyMiddleware(thunk, localStorage));
...
function fetchUrl(url) {
    return async (dispatch) => {
        try {
            ...
            dispatch({ type: "FETCH_SUCESS", payload: dados, localStorage: "dados" });
        } catch (erro) {
